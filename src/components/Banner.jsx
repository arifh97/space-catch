    ...
    <div className="banner position-relative overflow-hidden">
      <Container>
        <Row className='align-items-center justify-content-between'>
          <Col xs={12} lg={6}>
            <div className="banner-content text-center text-lg-start"  data-aos="fade-up" data-aos-offset="" data-aos-delay="">
              <h1 className='mb-3 pb-md-1 pb-lg-2 text-white'>SPACECATCH</h1>
              <p className='mb-4 pb-md-2 pb-lg-0 mb-lg-5 fw-medium'>At the forefront of Web3 AR gaming stands an unparalleled experience</p>
              <a href="#" className="btn d-inline-flex align-items-center justify-content-center" target='_blank'><span className='text-black rounded-pill d-flex align-items-center justify-content-center'><FaPlay /></span> WATCH THE TRAILER</a>
            </div>
          </Col>
          <Col xs={12} lg={6} xl={5}>
            <div className="banner-wrap mt-4 pt-2 pt-md-0 mt-md-5 mt-lg-0"  data-aos="fade-left" data-aos-offset="" data-aos-delay="">
